  ...
  while(1)
  {
    ...
    //switch(2)
    {
      ...
      /*case 2://getch();
	     ...
	     printf("\n\t\t\t%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240);
	     printf("\n\t\t\t%c                                  %c",221,221);
	     printf("\n\t\t\t%c  1. Create a List or Add a Node  %c\n\t\t\t%c  2. Add a Node after a Node      %c\n\t\t\t%c  3. Add a Node before a Node     %c\n\t\t\t%c  4. Delete a Node                %c\n\t\t\t%c  5. Display the List             %c\n\t\t\t%c  6. Exit                         %c",221,221,221,221,221,221,221,221,221,221,221,221,221,221,221);
	     printf("\n\t\t\t%c                                  %c",221,221);
	     printf("\n\t\t\t%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240);
	     delay(800);
	     beep();
	     ...
	     switch(ch2)
	     {
	       case 1:screen(4,15);
		      ...
		      disp_circular();
		      break;
	       case 2:add_after_circular();
		      break;
	       case 3:add_before_circular();
		      break;
	       case 4:del_circular();
		      break;
      ...
      case 3:getch();
	     ...
	     switch(ch2)
	     {
	       case 1:create_doubly();
		      break;
	       case 2:add_after_doubly();
		      break;
	       case 3:add_before_doubly();
		      break;
	       case 4:del_doubly();
		      break;
	       case 5:disp_doubly();
      ...
      case 4:getch();
	     ...
	     switch(ch2)
	     {
	       case 1:create_doubly_cir();
		      break;
	       case 2:add_after_doubly_cir();
		      break;
	       case 3:add_before_doubly_cir();
		      break;
	       case 4:del_doubly_cir();
		      break;
	       case 5:disp_doubly_cir();
		      break;
	       case 6:return;
	     }
	     setgraphmode(2);
	     break;
      case 5:setgraphmode(2);
	     setbkcolor(9);
