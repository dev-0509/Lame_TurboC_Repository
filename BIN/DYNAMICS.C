...
void main()
{
  int ch1,ch2,ch3,n,m,gd=DETECT,gm;
  int *ptr,*ptr2;
  clrscr();
    ...
    case 2:while(1)
	   {
	     ...
	     switch(ch3)
	     {
	       ...
	       case 2:printf("\n\tSpecify the total array elements : ");
		      scanf("%d",&n);
		      ptr=input_array(n);
		      improvised_selection_sort(ptr,n);
		      printf("\n\tThe Sorted Array is => \n\n");
		      getch();
		      display_array(ptr,n);
		      break;
	       ...
	       case 6:printf("\n\tSpecify the total array elements : ");
		      scanf("%d",&n);
		      ptr=input_array(n);
		      improvised_insertion_sort(ptr,n);
		      printf("\n\tThe Sorted Array is => \n\n");
		      getch();
		      display_array(ptr,n);
		      break;
	       ...
	       case 8:printf("\n\tSpecify the total array elements for the first array : ");
		      ...
		      scanf("%d",&m);
		      ptr2=input_array(m);
		      selection_sort(ptr2,m);
		      merge_sort(ptr,ptr2,n,m);
		      printf("\n\tThe Sorted Array is => \n\n");
		      getch();
